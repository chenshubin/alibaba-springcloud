package cn.murphy.controller;

import cn.murphy.entity.OrderInfo;
import cn.murphy.entity.ProductInfo;
import cn.murphy.mapper.OrderInfoMapper;
import cn.murphy.vo.OrderVo;
...
public class OrderInfoController {
    ...
    public Object selectOrderInfoById(@PathVariable("orderNo") String orderNo) {
         ...
         */
        List<ServiceInstance> serviceInstanceList =  discoveryClient.getInstances("d1-nacos-product");
    ...
    public List<ServiceInstance> getServiceList() {
        List<ServiceInstance> serviceInstanceList =  discoveryClient.getInstances("d1-nacos-order");
